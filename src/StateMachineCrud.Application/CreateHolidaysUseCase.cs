...
public class CreateHolidaysUseCase(IRequestsRepository conclusionsRepository)
	: IRequestHandler<CreateHolidaysRequest, Guid>
{
	...
	{
		var holidayConclusion = new NewHolidayRequest(Guid.NewGuid(), request.EmployeeName, request.StartDate, request.EndDate);
...
public class ApproveHolidayUseCase(IRequestsRepository conclusionsRepository)
...
public class RejectHolidayUseCase(IRequestsRepository conclusionsRepository)
...
public class CancelHolidayUseCase(IRequestsRepository conclusionsRepository)
